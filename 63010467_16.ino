...
void setup()
{
  ...
  char arr[20] = {0x41, 0x42, 0x43, 0x44, 0x45, 0x61, 0x62, 0x63, 0x64, 0x65,
                  0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30
                 };
//  char arr2[16] = {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
//                  0xff,0xff,0xff,0xff,0xff,0xff,};
  writeEEPROM_page(deviceAddress, eepromAddress , (byte *)arr, 16);
  writeEEPROM_page(deviceAddress, eepromAddress + 16 , (byte *)arr +16,5);
  char str[] = "CE-KMITL";
...
void dumpEEPROM(byte device, unsigned address, unsigned length)
{
 ...
 for (unsigned i = startAddress; i < stopAddress; i += 16)
 {
   ...
   {
     if (isprint(buffer[j]))  Serial.print(buffer[j]);
     else                     Serial.print('.');
   }
   Serial.println(" ");
 }
